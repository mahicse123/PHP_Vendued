...
//print_r($products);
    ...
    <div class="content">
      ...
      <div class="bidwindow">
        <div class="winner">
          <div class="text">
            Click Declare To End Bidding <br> Highest One Will Be Elected Winner
            <?php
            echo "<br>";
            //echo $products[0]['id'];
        ...
        <div class="bidding">
          ...
          <div class="details">
            <div class="adtitle">
              ...
              echo "<h5 style='color:indigo'> Price Expected By You: ".$products[0]['price']."/- </h5>";
        ...
        <div class="bidboard">
          ...
          <div class="offer">
            ...
            <div class="offerform">
              <form class="" action="/vendued/bidend.php" method="post">
                <input class="endbid" type="number" name="id" value="<?php echo $products[0]['id']; ?>" hidden>
                <?php
                ...
                if ($flag==-1) {
                  // code...
                  echo '<input class="endbid" type="submit" value="End Bidding">';
                }else {
                  // code...
                  echo '<input class="endedbid" type="submit" value="Bid ended" disabled>';
                }
                 ?>
